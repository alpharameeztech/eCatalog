        ...
        <div class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
            <div x-data="{ open: false }"
                ...
                <div class="p-4 flex flex-row items-center justify-between">
                    <a href="#"
                       class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">eCatalog</a>
        ...
        <div class="grid grid-cols-4 gap-4 mt-4">
            <div class="max-w-sm rounded overflow-hidden shadow-lg">
                ...
                <div class="px-6 py-4">
                    ...
                    <p class="text-gray-700 text-base">
                       By <a class="no-underline hover:underline text-blue-500 text-lg" href="">Chris</a>
                    </p>
                </div>
            </div>
            <div class="max-w-sm rounded overflow-hidden shadow-lg">
                <img class="w-full" src="https://cdn.wowdeals.me/uploads/catalogues/issues/33/12814/cover/300x406/1587536376.jpg" alt="Sunset in the mountains">
                <div class="px-6 py-4">
                    <div class="font-bold text-xl mb-2">The Coldest Sunset</div>
                    <p class="text-gray-700 text-base">
                        Super Deal
