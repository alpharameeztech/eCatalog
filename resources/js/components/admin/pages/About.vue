            ...
            <v-toolbar flat color="white">
                ...
                <v-dialog v-model="dialog" max-width="50%">
                    <template v-slot:activator="{ on }">
                        <v-btn color="primary" dark class="mb-2" v-on="on" v-if="!desserts.length">Add About Us Information</v-btn>
                    </template>
                     <v-tabs
                            fixed-tabs
...
import { VueEditor } from "vue2-editor";
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Add About Us Information' : 'Edit About Us Information'
            },
        },
